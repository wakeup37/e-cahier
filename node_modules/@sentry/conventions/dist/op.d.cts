...
declare const BROWSER_RESOURCE_AUDIO_SPAN_OP = "resource.audio";
declare const BROWSER_RESOURCE_VIDEO_SPAN_OP = "resource.video";
declare const BROWSER_RESOURCE_IFRAME_SPAN_OP = "resource.iframe";
...
declare const DATABASE_CACHE_GET_SPAN_OP = "cache.get";
declare const DATABASE_CACHE_PUT_SPAN_OP = "cache.put";
declare const DATABASE_CACHE_REMOVE_SPAN_OP = "cache.remove";
 ...
 */
declare const MESSAGING_QUEUE_SPAN_OP = "queue";
/**
 * Publishing a message to a queue.
 */
declare const MESSAGING_QUEUE_PUBLISH_SPAN_OP = "queue.publish";
/**
 * Creating a queue or a message for later publishing.
 */
declare const MESSAGING_QUEUE_CREATE_SPAN_OP = "queue.create";
/**
 * Receiving a message from a queue.
 */
declare const MESSAGING_QUEUE_RECEIVE_SPAN_OP = "queue.receive";
/**
 * Processing a message from a queue.
 */
declare const MESSAGING_QUEUE_PROCESS_SPAN_OP = "queue.process";
/**
 * Settling a message, e.g. acknowledging or rejecting it.
 */
declare const MESSAGING_QUEUE_SETTLE_SPAN_OP = "queue.settle";
/**
 * Publishing a message to an arq queue.
 */
declare const MESSAGING_QUEUE_SUBMIT_ARQ_SPAN_OP = "queue.submit.arq";
/**
 * Processing a message from an arq queue.
 */
declare const MESSAGING_QUEUE_TASK_ARQ_SPAN_OP = "queue.task.arq";
/**
 * Publishing a message to a Celery broker.
 */
declare const MESSAGING_QUEUE_SUBMIT_CELERY_SPAN_OP = "queue.submit.celery";
/**
 * Processing a message from a Celery queue.
 */
declare const MESSAGING_QUEUE_TASK_CELERY_SPAN_OP = "queue.task.celery";
/**
 * Processing a message from a Dramatiq queue.
 */
declare const MESSAGING_QUEUE_TASK_DRAMATIQ_SPAN_OP = "queue.task.dramatiq";
/**
 * Publishing a message to a Huey instance.
 */
declare const MESSAGING_QUEUE_SUBMIT_HUEY_SPAN_OP = "queue.submit.huey";
/**
 * Processing a message from a Huey instance.
 */
declare const MESSAGING_QUEUE_TASK_HUEY_SPAN_OP = "queue.task.huey";
/**
 * Processing a message from an RQ queue.
 */
declare const MESSAGING_QUEUE_TASK_RQ_SPAN_OP = "queue.task.rq";
...
export { BROWSER_BROWSER_PAINT_SPAN_OP, BROWSER_BROWSER_SPAN_OP, BROWSER_NAVIGATION_SPAN_OP, BROWSER_PAGELOAD_SPAN_OP, BROWSER_RESOURCE_AUDIO_SPAN_OP, BROWSER_RESOURCE_CSS_SPAN_OP, BROWSER_RESOURCE_IFRAME_SPAN_OP, BROWSER_RESOURCE_IMG_SPAN_OP, BROWSER_RESOURCE_LINK_SPAN_OP, BROWSER_RESOURCE_OTHER_SPAN_OP, BROWSER_RESOURCE_SCRIPT_SPAN_OP, BROWSER_RESOURCE_SPAN_OP, BROWSER_RESOURCE_VIDEO_SPAN_OP, BROWSER_UI_ACTION_CLICK_SPAN_OP, BROWSER_UI_ACTION_SPAN_OP, BROWSER_UI_ANGULAR_SPAN_OP, BROWSER_UI_EMBER_SPAN_OP, BROWSER_UI_LIVEWIRE_SPAN_OP, BROWSER_UI_REACT_MOUNT_SPAN_OP, BROWSER_UI_REACT_RENDER_SPAN_OP, BROWSER_UI_REACT_SPAN_OP, BROWSER_UI_REACT_UPDATE_SPAN_OP, BROWSER_UI_RENDER_SPAN_OP, BROWSER_UI_SPAN_OP, BROWSER_UI_SVELTE_SPAN_OP, BROWSER_UI_TASK_SPAN_OP, BROWSER_UI_VUE_SPAN_OP, DATABASE_CACHE_GET_SPAN_OP, DATABASE_CACHE_PUT_SPAN_OP, DATABASE_CACHE_REMOVE_SPAN_OP, DATABASE_CACHE_SPAN_OP, DATABASE_DB_QUERY_SPAN_OP, DATABASE_DB_SPAN_OP, FAAS_FUNCTION_AWS_SPAN_OP, FAAS_FUNCTION_AZURE_SPAN_OP, FAAS_FUNCTION_GCP_SPAN_OP, FAAS_GRPC_SPAN_OP, FAAS_HTTP_SPAN_OP, GENERAL_FUNCTION_SPAN_OP, GENERAL_MARK_SPAN_OP, GEN_AI_CHAT_SPAN_OP, GEN_AI_EXECUTE_TOOL_SPAN_OP, GEN_AI_HANDOFF_SPAN_OP, GEN_AI_INVOKE_AGENT_SPAN_OP, MESSAGING_QUEUE_CREATE_SPAN_OP, MESSAGING_QUEUE_PROCESS_SPAN_OP, MESSAGING_QUEUE_PUBLISH_SPAN_OP, MESSAGING_QUEUE_RECEIVE_SPAN_OP, MESSAGING_QUEUE_SETTLE_SPAN_OP, MESSAGING_QUEUE_SPAN_OP, MESSAGING_QUEUE_SUBMIT_ARQ_SPAN_OP, MESSAGING_QUEUE_SUBMIT_CELERY_SPAN_OP, MESSAGING_QUEUE_SUBMIT_HUEY_SPAN_OP, MESSAGING_QUEUE_TASK_ARQ_SPAN_OP, MESSAGING_QUEUE_TASK_CELERY_SPAN_OP, MESSAGING_QUEUE_TASK_DRAMATIQ_SPAN_OP, MESSAGING_QUEUE_TASK_HUEY_SPAN_OP, MESSAGING_QUEUE_TASK_RQ_SPAN_OP, MOBILE_APP_SPAN_OP, MOBILE_FILE_SPAN_OP, MOBILE_HTTP_SPAN_OP, MOBILE_NAVIGATION_SPAN_OP, MOBILE_SERIALIZE_SPAN_OP, MOBILE_UI_SPAN_OP, WEB_SERVER_APP_SPAN_OP, WEB_SERVER_CONSOLE_SPAN_OP, WEB_SERVER_FILE_SPAN_OP, WEB_SERVER_FUNCTION_NEXTJS_SPAN_OP, WEB_SERVER_FUNCTION_REMIX_SPAN_OP, WEB_SERVER_FUNCTION_SPAN_OP, WEB_SERVER_GRAPHQL_SPAN_OP, WEB_SERVER_GRPC_SPAN_OP, WEB_SERVER_HTTP_CLIENT_SPAN_OP, WEB_SERVER_HTTP_SERVER_SPAN_OP, WEB_SERVER_HTTP_SPAN_OP, WEB_SERVER_MIDDLEWARE_SPAN_OP, WEB_SERVER_RPC_SPAN_OP, WEB_SERVER_SERIALIZE_SPAN_OP, WEB_SERVER_SUBPROCESS_SPAN_OP, WEB_SERVER_TEMPLATE_SPAN_OP, WEB_SERVER_VIEW_SPAN_OP, WEB_SERVER_WEBSOCKET_SPAN_OP };
