...
function createVirtualIndexMiddleware(down) {
    return {
        ...
        table(tableName) {
            ...
            const { schema } = table;
            const indexLookup = Object.create(null);
                ...
                const tableMW = {
                    ...
                    query(req) {
                        ...
                        return cacheEntry.promise.then((res) => {
                            const result = applyOptimisticOps(res.result, req, tblCache?.optimisticOps, downTable, cacheEntry, freezeResults);
                            return {
