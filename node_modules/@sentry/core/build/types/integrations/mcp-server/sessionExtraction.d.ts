 ...
 */
import type { ExtraHandlerData, JsonRpcNotification, JsonRpcRequest, MCPTransport, PartyInfo, SessionData } from './types';
/**
 ...
 */
export declare function extractSessionDataFromMessage(message: JsonRpcRequest | JsonRpcNotification): SessionData;
/**
 ...
 */
export declare function extractSessionDataFromResponse(result: unknown): Partial<SessionData>;
/**
